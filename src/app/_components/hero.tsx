...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-white text-[#10183f]">
        ...
        <article className="grid grid-cols-1 gap-8 lg:grid-cols-1">
          <div className="space-y-6 pt-10 md:pt-0 relative z-30 flex flex-col items-center lg:items-center lg:max-w-[800px] lg:mx-auto">
            ...
            <h1
              ...
              data-aos="fade-down"
            >
              Agência de Tráfego Pago Automotivo!
            </h1>

            {/* Subtítulo */}
            <p
              className="text-[#10183f] lg:text-lg text-center leading-relaxed md:leading-[1.6]"
              data-aos="fade-right"
            >
              Potencializamos suas vendas através do Tráfego Pago.
            </p>
      ...
      {/* Faixa azul */}
      <div className="absolute top-[calc(12rem)] -mt-30 sm:-mt-30 left-0 w-screen bg-[#10183f] text-white text-center font-semibold py-2 z-0">
        Exclusivo para lojas de veículos
      </div>
       
      {/* Badge redonda */}
      <div className="absolute top-[calc(12rem+3rem)] left-1/2 -mt-27 sm:-mt-23 transform -translate-x-1/2 bg-[#cdfab9] text-[#10183f] font-semibold rounded-full px-6 py-1 z-30 text-center whitespace-nowrap">
